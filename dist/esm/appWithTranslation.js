...
export var appWithTranslation = function appWithTranslation(WrappedComponent) {
  ...
  var AppWithTranslation = function AppWithTranslation(props) {
    var _ref2, _nextI18Next$initialL, _props$router;

    var _ref = props.pageProps,
        _nextI18Next = _ref._nextI18Next;
    var locale = (_ref2 = (_nextI18Next$initialL = _nextI18Next === null || _nextI18Next === void 0 ? void 0 : _nextI18Next.initialLocale) !== null && _nextI18Next$initialL !== void 0 ? _nextI18Next$initialL : props === null || props === void 0 ? void 0 : (_props$router = props.router) === null || _props$router === void 0 ? void 0 : _props$router.locale) !== null && _ref2 !== void 0 ? _ref2 : null; // Memoize the instance and only re-initialize when either:
    // 1. The route changes (non-shallowly)
    // 2. Router locale changes
    // 3. UserConfig override changes

    var i18n = useMemo(function () {
      var _ref3, _userConfig, _userConfig2, _userConfig2$i18n, _nextI18Next$userConf;

      if (!_nextI18Next && !configOverride) return null;
      var userConfig = (_ref3 = configOverride !== null && configOverride !== void 0 ? configOverride : _nextI18Next === null || _nextI18Next === void 0 ? void 0 : _nextI18Next.userConfig) !== null && _ref3 !== void 0 ? _ref3 : null;
      ...
      var _ref4 = _nextI18Next || {},
          initialI18nStore = _ref4.initialI18nStore;
      ...
      var instance = createClient(_objectSpread(_objectSpread({}, createConfig(_objectSpread(_objectSpread({}, userConfig), {}, {
        ...
        lng: locale,
        resources: resources
      }), _nextI18Next === null || _nextI18Next === void 0 ? void 0 : (_nextI18Next$userConf = _nextI18Next.userConfig) === null || _nextI18Next$userConf === void 0 ? void 0 : _nextI18Next$userConf.key).i18n;
      globalI18n = instance;
      return instance;
