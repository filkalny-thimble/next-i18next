...
describe('appWithTranslation', function () {
  ...
  it('assures locale key is set to the right value', function () {
    ...
    var _mock$calls7 = (0, _slicedToArray2["default"])(_reactI18next.I18nextProvider.mock.calls, 5),
        _mock$calls7$ = (0, _slicedToArray2["default"])(_mock$calls7[0], 1),
        first = _mock$calls7$[0],
        _mock$calls7$2 = (0, _slicedToArray2["default"])(_mock$calls7[1], 1),
        second = _mock$calls7$2[0],
        _mock$calls7$3 = (0, _slicedToArray2["default"])(_mock$calls7[2], 1),
        third = _mock$calls7$3[0],
        _mock$calls7$4 = (0, _slicedToArray2["default"])(_mock$calls7[3], 1),
        fourth = _mock$calls7$4[0],
        _mock$calls7$5 = (0, _slicedToArray2["default"])(_mock$calls7[4], 1),
        fifth = _mock$calls7$5[0];
