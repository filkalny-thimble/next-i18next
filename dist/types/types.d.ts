...
export declare type UserConfigKeyed = UserConfig & {
    key?: string;
};
export declare type UserConfigOverrideSSP = Omit<UserConfigKeyed, 'configOverrideKeys'>;
export declare type UserConfigOverrideHOC = Omit<UserConfigOverrideSSP, 'key'>;
export declare type InternalConfig = Omit<UserConfigKeyed, 'i18n'> & NextJsI18NConfig & {
